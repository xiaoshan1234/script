...
os.system("conda config --add channels https://mirrors.ustc.edu.cn/anaconda/pkgs/main/")
os.system("conda config --add channels https://mirrors.ustc.edu.cn/anaconda/pkgs/free/")
os.system("conda config --add channels https://mirrors.ustc.edu.cn/anaconda/cloud/conda-forge/")
os.system("conda config --add channels https://mirrors.ustc.edu.cn/anaconda/cloud/msys2/")
os.system("conda config --add channels https://mirrors.ustc.edu.cn/anaconda/cloud/bioconda/")
os.system("conda config --add channels https://mirrors.ustc.edu.cn/anaconda/cloud/menpo/")
